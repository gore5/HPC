...
#pragma omp parallel num_threads(2) private(sum, i, rowMax, rowMin, j, m, n, colMax, colMin) firstprivate(kPtr, inPtr, inPtr2, outPtr)
{
...
//#pragma omp parallel num_threads(2) private(n, kPtr, inPtr)
